...
On 2026-07-18, `.\scripts\validate.ps1` passed TypeScript, all 310 tests across 47 files, and the Next.js production build. Focused automated coverage uses mocked generation and does not call live Gemini.
