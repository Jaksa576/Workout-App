...
function makeSchedule(input: PlanDraftInput): Weekday[] {
  ...
  return Array.from(new Set(normalizedDays)).slice(
    0,
    Math.max(1, input.setup.daysPerWeek),
  );
}
...
function hasUsableEquipment(
  ...
  return item.equipmentTags.some(
    (tag) => tag === "Bodyweight" || availableEquipment.has(tag),
  );
}
...
function rankCandidates(items: ExerciseCatalogItem[], input: PlanDraftInput) {
  ...
  return items
    .map((item, index) => ({
      item,
      index,
      score: preferenceScore(item, preferenceTerms),
    }))
...
function pickCatalogItem(
  ...
  const selected =
    ...
    rankedCandidates.find((item) =>
      hasUsableEquipment(item, availableEquipment),
    ) ??
    rankedCandidates.find(
      (item) =>
        !matchesDislike(item, dislikeTerms) && !selectedIds.has(item.id),
    ) ??
...
function trimWorkouts(
  ...
  const count = Math.max(
    1,
    Math.min(workouts.length, requestedDays, maxWorkouts),
  );
        ...
        },
        {
          ...
          slots: isRecovery
            ? [
                ...
                { ids: ["box-squat", "half-kneeling-hip-flexor-stretch"] },
              ]
            : [
      ...
      workouts: [
        {
          ...
          slots: [
            ...
            { ids: ["bird-dog", "half-kneeling-hip-flexor-stretch"] },
          ],
        },
        {
      ...
      workouts: [
        {
          ...
          focus: "Strength base",
          summary:
            "A balanced strength day built around easy-to-repeat patterns.",
          slots: [
        ...
        },
        {
          ...
          summary:
            "Simple conditioning with core support for a more rounded week.",
          slots: [
            { ids: ["brisk-walk", "low-impact-cardio-march"] },
            { ids: ["dead-bug", "side-plank"] },
            { ids: ["half-kneeling-hip-flexor-stretch", "thoracic-rotation"] },
          ],
        },
        {
          ...
          summary:
            "A lighter session that builds useful capacity without piling on fatigue.",
          slots: [
            { ids: ["romanian-deadlift", "glute-bridge", "hip-hinge-drill"] },
            { ids: ["farmer-carry", "band-row", "side-plank"] },
            { ids: ["ankle-rock", "half-kneeling-hip-flexor-stretch"] },
          ],
        },
      ],
    },
      ...
      workouts: [
        {
          ...
          summary:
            "A slightly more capable full-body day while keeping the structure familiar.",
          slots: [
        ...
        },
        {
          ...
          summary:
            "A steady support session for maintaining momentum between strength days.",
          slots: [
            { ids: ["brisk-walk", "low-impact-cardio-march"] },
        ...
        },
        {
          ...
          summary:
            "A support day that rounds out the week and keeps recovery manageable.",
          slots: [
            { ids: ["romanian-deadlift", "glute-bridge", "hip-hinge-drill"] },
            { ids: ["farmer-carry", "band-row", "dead-bug"] },
            { ids: ["thoracic-rotation", "half-kneeling-hip-flexor-stretch"] },
          ],
        },
      ],
    },
      ...
      workouts: [
        {
          ...
          slots: [
            ...
            {
              ids: ["dumbbell-floor-press", "push-up", "incline-push-up"],
              overrides: main,
            },
            {
              ids: ["dumbbell-row", "band-row", "side-plank"],
        ...
        },
        {
          ...
          summary:
            "A hinge-focused strength day with enough support work to stay balanced.",
          slots: [
            {
              ids: [
                "romanian-deadlift",
        ...
        },
        {
          ...
          summary:
            "A third day for extra practice when your weekly schedule supports it.",
          slots: [
            {
              ids: [
                "step-up",
    ...
    },
    {
      ...
      workouts: [
        ...
        },
        {
          ...
          summary:
            "A stronger hinge day that still respects your setup and constraints.",
          slots: [
            {
              ids: ["romanian-deadlift", "glute-bridge", "hip-hinge-drill"],
              overrides: main,
            ...
            {
              ids: ["step-up", "reverse-lunge", "walking-lunge"],
              overrides: accessory,
            },
            {
              ids: ["side-plank", "dead-bug", "farmer-carry"],
              overrides: accessory,
            },
          ],
        },
        {
          ...
          slots: [
            ...
            {
              ids: ["band-row", "dumbbell-row", "farmer-carry", "dead-bug"],
              overrides: accessory,
            },
            { ids: accessoryIds, overrides: accessory },
          ],
      ...
      workouts: [
        {
          ...
          summary:
            "A lower-body day centered on the main squat and hinge patterns.",
          slots: [
            {
              ids: [
                "barbell-back-squat",
            ...
            {
              ids: ["calf-raise", "dead-bug", "side-plank"],
              overrides: accessory,
            },
          ],
        },
        {
          ...
          summary:
            "A simple upper-body session with balanced pressing and rowing.",
          slots: [
            {
              ids: ["dumbbell-floor-press", "push-up", "incline-push-up"],
              overrides: main,
        ...
        },
        {
          ...
          summary:
            "A second lower-body day with unilateral strength and posterior-chain support.",
          slots: [
            {
              ids: [
                "step-up",
            ...
            {
              ids: ["side-plank", "dead-bug", "calf-raise"],
              overrides: accessory,
            },
          ],
        },
      ...
      workouts: [
        {
          ...
          summary:
            "Repeat the lower-body base with a slightly stronger training rhythm.",
          slots: [
            {
              ids: [
                "barbell-back-squat",
            ...
            {
              ids: ["dead-bug", "calf-raise", "side-plank"],
              overrides: accessory,
            },
          ],
        },
        {
          ...
          summary:
            "Repeat the upper-body base with clearer intent and manageable volume.",
          slots: [
            {
              ids: ["dumbbell-floor-press", "push-up", "incline-push-up"],
              overrides: main,
        ...
        },
        {
          ...
          summary:
            "Support lower-body strength or volume with controlled unilateral work.",
          slots: [
            {
              ids: ["romanian-deadlift", "glute-bridge", "hip-hinge-drill"],
              overrides: main,
            ...
            {
              ids: ["reverse-lunge", "step-up", "walking-lunge"],
              overrides: accessory,
            },
            {
              ids: ["calf-raise", "side-plank", "dead-bug"],
              overrides: accessory,
            },
          ],
        },
      ...
      workouts: [
        {
          ...
          summary:
            "A run/walk session represented in the current exercise-style plan model.",
          slots: [
        ...
        },
        {
          ...
          summary:
            "Strength work that supports running without turning the day into a heavy lift.",
          slots: [
            { ids: ["glute-bridge", "hip-hinge-drill"] },
        ...
        },
        {
          ...
          summary:
            "Mobility and trunk work to keep the running week manageable.",
          slots: [
            { ids: ["half-kneeling-hip-flexor-stretch", "thoracic-rotation"] },
      ...
      workouts: [
        {
          ...
          summary:
            "A simple easy-run session represented in the current exercise-style plan model.",
          slots: [
        ...
        },
        {
          ...
          summary:
            "A light support day that can absorb fatigue from the run day.",
          slots: [
            { ids: ["stride-drills", "brisk-walk"] },
            { ids: ["half-kneeling-hip-flexor-stretch", "ankle-rock"] },
            { ids: ["dead-bug", "side-plank"] },
          ],
        },
      ],
      ...
      workouts: [
        {
          ...
          summary:
            "A general strength day to support sport work without over-specializing.",
          slots: [
            { ids: ["goblet-squat", "bodyweight-squat", "reverse-lunge"] },
            { ids: ["romanian-deadlift", "glute-bridge", "hip-hinge-drill"] },
      ...
      workouts: [
        {
          ...
          summary:
            "Repeat the strength base with a slightly stronger support pattern.",
          slots: [
            { ids: ["goblet-squat", "reverse-lunge", "bodyweight-squat"] },
            { ids: ["push-up", "incline-push-up", "dumbbell-floor-press"] },
            { ids: ["dumbbell-row", "band-row", "farmer-carry", "side-plank"] },
        ...
        },
        {
          ...
          summary:
            "A second lateral day that remains conservative when constraints are present.",
          slots: [
        ...
        },
        {
          ...
          summary:
            "A support session for the pieces that keep sport training sustainable.",
          slots: [
...
function getPlanName(input: PlanDraftInput) {
  ...
  if (input.setup.goalType === "sport_performance") {
    ...
    return sport
      ? `${sport} Performance Starter Plan`
      : "Sport Performance Starter Plan";
  }
...
export function createGuidedStarterPlan(
  input: PlanDraftInput,
): StructuredPlanInput {
